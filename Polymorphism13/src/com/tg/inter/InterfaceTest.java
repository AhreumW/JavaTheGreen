 ...
 * 	인터페이스는 일종의 추상클래스이다. 인터페이스는 추상클래스처럼 추상메서드를 갖지만
	...
	표현식(expression)
		접근제어자 interface 인터페이스이름{
			public static final 타입 상수이름 = 값;			//상수:변하지않는값 = final
...
public interface InterfaceTest {
	...
	//밑 4개(대문자) 전부 묵시적으로 public static final 됨
	public static final int MAX_CHANNEL = 100;		//static final : 절대불변
	final int MAX_VOLUME = 10;
	static int DACHUNG = 2;
	
	int NUMBER = 1;		//알아서 자동으로 붙음 + public static final
	
	//상속이 강요되서 호출시 구체화
	//묵시적으로 public abstract이 붙음
